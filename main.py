...
file_path = "./BWWBS-GUI/Sent.xlsx"

# Call the function
delete_rows_except_first(file_path)

# Provide the path to your Excel file
file_path = "./BWWBS-GUI/NotSent.xlsx"
...
# Load the Excel file
workbook = openpyxl.load_workbook('./BWWBS-GUI/num.xlsx')
...
with open('./BWWBS-GUI/numbers.txt', 'w') as file:
